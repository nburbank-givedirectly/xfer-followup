...
SELECT fu.Id AS fu_id,
       ...
       t.record_type_name,
       t.project_name,
       t.transfer_created_date,
       t.original_scheduled_date,
       t.most_recent_attempt_date,
       t.completed_date,
       t.transfer_status,
       t.discarded_duplicate,
       t.recipient_inactive_stage,
       t.transfer_inactive,
       t.transfer_completed,
       t.transfer_amount_commitment_complete_usd,
       t.transfer_amount_commitment_outstanding_usd,
       t.index_one_on_time,
       t.index_later_delay_flup,
